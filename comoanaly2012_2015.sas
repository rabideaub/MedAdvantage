...
/***********************************************************/
%let path= /sch-projects/dua-data-projects/VERTICAL-INTEGRATION/rabideau/Programs/MedAdvantage;
...
LIBNAME LIBRARY '/sch-projects/dua-data-projects/VERTICAL-INTEGRATION/rabideau/Documentation'; 	   
...
DATA collapsed_&DX._elix;
    ...
    SET  An_files.&CORE (KEEP=HICNO &DRG. &DIAG.1-&DIAG.&NUMDX. /*NDX*/);
...
data An_files.collapsed_&DX._elix;
	merge An_files.&CORE.
		  collapsed_&DX._elix;
run;
...
/*************************************************/  
PROC PRINT DATA=An_files.collapsed_&DX._elix (OBS=60);
